...
//			System.out.print(i+"->");
	 ...
	 * @version 1.0
	 */
	public static int recogerOpcionMenus(int n1,int n2) {//metodo que recoge la opcion del menu y la devuelve
		Scanner teclado=new Scanner(System.in);
		int opcion;//declaro la variable
		boolean valido=false;
		do {//inicio del bucle
			...
			opcion=teclado.nextInt();//recojo el valor introducido por teclado y lo almaceno en la variable opcion
			if (opcion<n1||opcion>n2) {//si la opcion es menor que 1 
				System.out.println("Opción incorrecta, debes elegir un número entre "+ n1+" y "+ n2);//muestro el mensaje
